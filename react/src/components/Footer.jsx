...
export default function Footer() {
    return (
        <div id='footer'>
            ...
            <span className='copyright-text'>Київська Державна Академія Декоративно-Прикладного Мистецтва і Дизайну імені Михайла Бойчука © 1999-2021<br></br>Розроблено за підтримкою КПІ ім. Ігоря Сікорського та LIDDWEB LLC</span>
        </div>
    )
}       